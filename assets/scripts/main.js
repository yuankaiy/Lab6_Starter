...
function initFormHandler() {
	...
	formEl.addEventListener('submit', (event) => {
		...
		event.preventDefault(); //needed to prevent refresh (like in the video)

		let formData = new FormData(formEl); // B4
		let recipeObject = {}; // B5

		for(let [key, value] of formData.entries()){ //B5
		...
		localStorage.setItem('recipes', JSON.stringify(recipesArr)); //B9
